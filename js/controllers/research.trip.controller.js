(function () {
    ...
    angular
        .module('app')
        .controller('ResearchTripController', ResearchTripController);

    ResearchTripController.$inject = ['$location', '$localstorage', 'DataService', '$timeout', '$window'];

    function ResearchTripController($location, $localstorage, DataService, $timeout, $window) {
        var vm = this;
        vm.loading = true;
